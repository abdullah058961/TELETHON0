#    جميع الحقوق لمطور سورس فايدر  فقط
#    اذا تاخد الملف اذن الحقوق لكاتبه ومطوره لا تحذف الحقوق وتصير فاشل 👍
#    كتابة عبدالله 
import asyncio
import io
import re
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/VV_338"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب فايدر  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/VV_338")],
            ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("كروب المساعدة ❓", "https://t.me/FF_514")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @FR_754", alert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #    قـسـم  الزغرفـة فايدر
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
