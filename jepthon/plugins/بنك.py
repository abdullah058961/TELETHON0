...
- مثال: .انشاء حساب الرافدين او فايدر الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "فايدر الاسلامي":
        bankn = "مصرف فايدر الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "فايدر الاسلامي":
