...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m WWWL5`",
        "**State changed from starting to up**",
        "__INFO:WWWL5:Logged in as 557667062__",
        "__INFO:WWWL5:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jepiq.on(admin_cmd(pattern="احبك"))
async def rz(WWWL5):
    roz = random.choice(love)
    return await edit_or_reply(WWWL5, roz)
